...
export default async function VillePage({ params }: PageProps) {
  ...
  // Photo du LIEU (monument/quartier) : pas de photo famille ici
        ...
        <div className="relative h-64 md:h-80 w-full">
          ...
          <div className="absolute bottom-6 left-0 right-0 px-4 sm:px-6 max-w-6xl mx-auto">
            <p className="text-white/70 text-sm mb-1">
              <a href="/" className="hover:text-white">Accueil</a> / <a href="/destinations" className="hover:text-white">Destinations</a> / France
            </p>
        ...
        <div className="relative">
          ...
          <div className="absolute top-6 left-0 right-0 px-4 sm:px-6 max-w-6xl mx-auto">
            <p className="text-white/70 text-sm">
              <a href="/">Accueil</a> / <a href="/destinations">Destinations</a> / France
            </p>
          </div>
        </div>
      )}
