      ...
      typography: (theme) => ({
        DEFAULT: {
          css: {
            ...
            h1: { fontFamily: theme('fontFamily.display').join(', '), color: theme('colors.texte.DEFAULT') },
            h2: { fontFamily: theme('fontFamily.display').join(', '), color: theme('colors.texte.DEFAULT') },
            h3: { fontFamily: theme('fontFamily.display').join(', '), color: theme('colors.texte.DEFAULT') },
